...
try {
    ...
    echo "Error fetching profile: " . htmlspecialchars($e->getMessage());
    exit;
}
...
$profilePic = !empty($user['u_profile_pic']) 
    ? htmlspecialchars($user['u_profile_pic']) 
  ...
  <main> 
    <div class="profile-panel">
      ...
      <div class="profile-card" id="profile-card">
        <img src="<?= $profilePic ?>" 
             alt="Profile picture of <?= htmlspecialchars($user['u_name']) ?>">
        <div class="mini-info">
